...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Map<String, double> _previousRSSI = {}; // Store previous Smoothed RSSI values
    ...
    try {
      ...
      setState(() {
        for (var device in devices) {
          ...
          double smoothedRSSI = device["smoothed_rssi"] ?? -100.0;

          if (_previousRSSI.containsKey(address)) {
            double previousRSSI = _previousRSSI[address]!;

            if (smoothedRSSI > previousRSSI) {
              device["movement"] = "Moving Closer";
            } else if (smoothedRSSI < previousRSSI) {
          ...
          _previousRSSI[address] = smoothedRSSI; // Update previous RSSI
        }
                ...
                child: SlideAnimation(
                  ...
                  child: FadeInAnimation(
                    child: DeviceCard(
                      ...
                      distance:
                          device["estimated_distance"]?.toStringAsFixed(2) ??
                          "Unknown",
